...
public class RiakPerfTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        log.info("hostname {}; nKeys {}; nThreads {}", hostname, nKeys, nThreads);
        final RiakClient client = RiakClient.newClient(hostname);
        ...
        final JobGenerator readJobGenerator = new RiakReadJobGenerator(client, bucket, nKeys, histogram);
    ...
    private static class RiakReadJobGenerator implements JobGenerator {
        ...
        public RiakReadJobGenerator(RiakClient client, Namespace bucket, long nKeys, Histogram histogram) {
            runnable = () -> {
                try {
